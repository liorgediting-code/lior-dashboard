...
import type { Client, BaselineSnapshot, SopGate, ClientCurrentMetrics, DriveLink } from "@dashboard-lior/shared";
...
export default async function ClientProfilePage({
  ...
  const [{ data: client }, { data: baseline }, { data: gates }, { data: currentMetricsRows }] = await Promise.all([
